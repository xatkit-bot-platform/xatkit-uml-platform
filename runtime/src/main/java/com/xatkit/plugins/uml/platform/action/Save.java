...
public class Save extends RuntimeAction<UmlPlatform> {
    ...
    protected Object compute() throws Exception {
        ...
        sb.append("@startuml\n");
        /*
         * This header ensures that the generated model is never empty (and thus the default PlantUML image is never
         * printed).
         */
        sb.append("header Generated by Xatkit UML Platform\n");
